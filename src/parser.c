...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [4] = {
    ...
    [sym_nested_comment] = ACTIONS(48),
    [sym_directive] = ACTIONS(48),
    [aux_sym_boolean_token1] = ACTIONS(48),
    [aux_sym_boolean_token2] = ACTIONS(48),
    [anon_sym_POUND] = ACTIONS(50),
    [sym_string] = ACTIONS(48),
    [sym_number] = ACTIONS(50),
    [aux_sym_identifier_token1] = ACTIONS(50),
    [aux_sym_identifier_token2] = ACTIONS(48),
  ...
  [5] = {
    ...
    [aux_sym_identifier_token2] = ACTIONS(52),
  ...
  [6] = {
    ...
    [sym_nested_comment] = ACTIONS(56),
    [sym_directive] = ACTIONS(56),
    [aux_sym_boolean_token1] = ACTIONS(56),
    [aux_sym_boolean_token2] = ACTIONS(56),
    [anon_sym_POUND] = ACTIONS(58),
    [sym_string] = ACTIONS(56),
    [sym_number] = ACTIONS(58),
    [aux_sym_identifier_token1] = ACTIONS(58),
    [aux_sym_identifier_token2] = ACTIONS(56),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(9),
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(8),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_character, 2),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_character, 2),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 2),
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list, 2),
